 ...
 */
final class Version20190608053220 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE tags tags VARCHAR(255) DEFAULT NULL, CHANGE text body LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE tags tags VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE body text LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
