 ...
 */
final class Version20190908100401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE problem_submission_result CHANGE time time DOUBLE PRECISION NOT NULL, CHANGE memory memory DOUBLE PRECISION NOT NULL, CHANGE error error VARCHAR(1000) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE problem_submission_result CHANGE time time SMALLINT NOT NULL, CHANGE memory memory SMALLINT NOT NULL, CHANGE error error VARCHAR(1000) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
